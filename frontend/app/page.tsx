...
export default function HomePage() {
  const whyChooseUs = [
    { title: "Berdiri Sejak 1993", desc: "Berpengalaman lebih dari 30 tahun melayani masyarakat Cianjur.", icon: <FaHistory /> },
  ...
  const testimonials = [
    { name: "Bapak Budi", role: "Pelanggan Home Service", text: "Pelayanan sangat cepat dan teknisi ramah. TV LED saya yang tadinya mati total sekarang sudah nyala lagi seperti baru. Mantap Servis Cianjur!" },
  ...
  const profile = {
    heroTitle: "Servis Elektronik Terpercaya di Cianjur Sejak 1993",
    ...
    aboutText1: "Berdiri sejak tahun 1993, Servis Cianjur telah menjadi tempat servis elektronik pilihan utama masyarakat di Kabupaten Cianjur dan sekitarnya.",
  ...
  return (
    <div className="bg-gray-50 flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center md:text-left md:flex md:items-center">
          <div className="md:w-2/3 pr-0 md:pr-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <a href={profile.whatsappUrl} target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-white text-white font-bold py-4 px-8 rounded-full hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 text-center flex items-center justify-center gap-2 backdrop-blur-sm">
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="text-center">
            <Link href="/services" className="inline-flex items-center justify-center bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-10 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((item, index) => (
              <div key={index} className="p-4">
                <div className="text-5xl font-extrabold mb-2 drop-shadow-md">{item.value}</div>
                <div className="text-red-100 font-medium">{item.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-16">Apa Kata Pelanggan Kami?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testi, i) => (
              <div key={i} className="bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-xl transition-shadow relative">
            ...
            <div className="md:w-1/2 p-10 md:p-14 bg-gray-50">
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6 group cursor-pointer">
                  <a href={profile.whatsappUrl} target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-2xl group-hover:bg-green-600 group-hover:text-white transition-colors duration-300 flex-shrink-0">
                    <FaWhatsapp />
                  </a>
                  <div>
                ...
                <div className="flex items-center gap-6 group cursor-pointer">
                  <a href={`mailto:${profile.email}`} className="w-14 h-14 bg-red-100 text-red-600 rounded-full flex items-center justify-center text-2xl group-hover:bg-red-600 group-hover:text-white transition-colors duration-300 flex-shrink-0">
                    <FaEnvelope />
                  </a>
                  <div>
                ...
                <div className="flex items-center gap-6">
                  <div className="w-14 h-14 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-2xl flex-shrink-0">
                    <FaClock />
                  </div>
                  <div>
