...
import { getAll, getById, create, update, remove, addPayment } from '../controllers/invoice.controller.js';
...
router.post('/:id/payments', authorize(['SUPER_ADMIN', 'OWNER', 'ADMIN', 'TEKNISI']), addPayment);
